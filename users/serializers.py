...
class CustomUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['username', 'email', 'phone_number', 'gender', 'age', 'email_verified', 'mobile_verified']
        depth = 1
...
class GoogleSocialAuthSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            CustomUser.objects.create_user(email=email, username=username, password=password , auth_provider='google', email_verified=True)
            return {
