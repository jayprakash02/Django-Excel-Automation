...
def create_excel(sender, instance, **kwargs):
    if instance.question_type == 'ID' and DEBUG:
        ...
        row = ['Closed', str(datetime.datetime.now()), dummy.question_type, dummy.category,
               dummy.sub_category, dummy.decade, dummy.genre, dummy.word, dummy.selection, str(instance.user.user_id), str(instance.approverEmail.user_id)]
