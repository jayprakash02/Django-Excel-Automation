...
def create_excel(sender, instance, **kwargs):
    if instance.question_type == 'LV' :
        ...
        row1 = ["Open", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},why would you {1}?'.format(situation,subject),'Spirit',Lf.need["need"][0],8, Lf.wish["wish"][0],6, Lf.desire["desire"][0],4,  Lf.want["want"][0],2, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Open", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},why would you {1}?'.format(situation,subject),'Spirit',Lf.need["need"][0],8, Lf.wish["wish"][0],6, Lf.desire["desire"][0],4,  Lf.want["want"][0],2, str(instance.user.user_id), str(instance.approver.user_id)]
        row2 = ["Open", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},when would you do {1}?'.format(situation,subject) ,'Profession',Lf.need["need"][1],2, Lf.wish["wish"][1],4, Lf.desire["desire"][1],6,  Lf.want["want"][1],8, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Open", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},when would you do {1}?'.format(situation,subject) ,'Profession',Lf.need["need"][1],2, Lf.wish["wish"][1],4, Lf.desire["desire"][1],6,  Lf.want["want"][1],8, str(instance.user.user_id), str(instance.approver.user_id)]
        row3 = ["Open", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},who would you do {1}?'.format(situation,subject) ,'Purpose',Lf.need["need"][2],8, Lf.wish["wish"][2],6, Lf.desire["desire"][2],4,  Lf.want["want"][2],2, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Open", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},who would you do {1}?'.format(situation,subject) ,'Purpose',Lf.need["need"][2],8, Lf.wish["wish"][2],6, Lf.desire["desire"][2],4,  Lf.want["want"][2],2, str(instance.user.user_id), str(instance.approver.user_id)]
        row4 = ["Open", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},what would you like in return for doing {1}?'.format(situation,subject) ,'Reward',Lf.need["need"][3],2, Lf.wish["wish"][3],4, Lf.desire["desire"][3],6,  Lf.want["want"][3],8, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Open", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},what would you like in return for doing {1}?'.format(situation,subject) ,'Reward',Lf.need["need"][3],2, Lf.wish["wish"][3],4, Lf.desire["desire"][3],6,  Lf.want["want"][3],8, str(instance.user.user_id), str(instance.approver.user_id)]
...
def create_excel(sender, instance, **kwargs):
    if instance.question_type == 'ID' and DEBUG:
        ...
        row1 = ["Open Leading", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},why would you {1}?'.format(situation,subject),'Spirit',Lf.need["need"][0],8, Lf.wish["wish"][0],6, Lf.desire["desire"][0],4,  Lf.want["want"][0],2, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Open Leading", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},why would you {1}?'.format(situation,subject),'Spirit',Lf.need["need"][0],8, Lf.wish["wish"][0],6, Lf.desire["desire"][0],4,  Lf.want["want"][0],2, str(instance.user.user_id), str(instance.approver.user_id)]
        row2 = ["Open Leading", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},when would you do {1}?'.format(situation,subject) ,'Profession',Lf.need["need"][1],2, Lf.wish["wish"][1],4, Lf.desire["desire"][1],6,  Lf.want["want"][1],8, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Open Leading", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},when would you do {1}?'.format(situation,subject) ,'Profession',Lf.need["need"][1],2, Lf.wish["wish"][1],4, Lf.desire["desire"][1],6,  Lf.want["want"][1],8, str(instance.user.user_id), str(instance.approver.user_id)]
        row3 = ["Open Leading", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},who would you do {1}?'.format(situation,subject) ,'Purpose',Lf.need["need"][2],8, Lf.wish["wish"][2],6, Lf.desire["desire"][2],4,  Lf.want["want"][2],2, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Open Leading", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},who would you do {1}?'.format(situation,subject) ,'Purpose',Lf.need["need"][2],8, Lf.wish["wish"][2],6, Lf.desire["desire"][2],4,  Lf.want["want"][2],2, str(instance.user.user_id), str(instance.approver.user_id)]
        row4 = ["Open Leading", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},what would you like in return for doing {1}?'.format(situation,subject) ,'Reward',Lf.need["need"][3],2, Lf.wish["wish"][3],4, Lf.desire["desire"][3],6,  Lf.want["want"][3],8, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Open Leading", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},what would you like in return for doing {1}?'.format(situation,subject) ,'Reward',Lf.need["need"][3],2, Lf.wish["wish"][3],4, Lf.desire["desire"][3],6,  Lf.want["want"][3],8, str(instance.user.user_id), str(instance.approver.user_id)]
...
def create_excel(sender, instance, **kwargs):
    if instance.question_type == 'ID' and DEBUG:
        ...
        row1 = ["Closed", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},why would you {1}?'.format(situation,subject),'Spirit',Lf.need["need"][0],8, Lf.wish["wish"][0],6, Lf.desire["desire"][0],4,  Lf.want["want"][0],2, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Closed", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},why would you {1}?'.format(situation,subject),'Spirit',Lf.need["need"][0],8, Lf.wish["wish"][0],6, Lf.desire["desire"][0],4,  Lf.want["want"][0],2, str(instance.user.user_id), str(instance.approver.user_id)]
        row2 = ["Closed", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},when would you do {1}?'.format(situation,subject) ,'Profession',Lf.need["need"][1],2, Lf.wish["wish"][1],4, Lf.desire["desire"][1],6,  Lf.want["want"][1],8, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Closed", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},when would you do {1}?'.format(situation,subject) ,'Profession',Lf.need["need"][1],2, Lf.wish["wish"][1],4, Lf.desire["desire"][1],6,  Lf.want["want"][1],8, str(instance.user.user_id), str(instance.approver.user_id)]
        row3 = ["Closed", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},who would you do {1}?'.format(situation,subject) ,'Purpose',Lf.need["need"][2],8, Lf.wish["wish"][2],6, Lf.desire["desire"][2],4,  Lf.want["want"][2],2, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Closed", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},who would you do {1}?'.format(situation,subject) ,'Purpose',Lf.need["need"][2],8, Lf.wish["wish"][2],6, Lf.desire["desire"][2],4,  Lf.want["want"][2],2, str(instance.user.user_id), str(instance.approver.user_id)]
        row4 = ["Closed", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},what would you like in return for doing {1}?'.format(situation,subject) ,'Reward',Lf.need["need"][3],2, Lf.wish["wish"][3],4, Lf.desire["desire"][3],6,  Lf.want["want"][3],8, str(instance.user.user_id), str(instance.approver.user_id), "", "", "Closed", str(datetime.datetime.now()), subject, situation,'When/If you are in {0},what would you like in return for doing {1}?'.format(situation,subject) ,'Reward',Lf.need["need"][3],2, Lf.wish["wish"][3],4, Lf.desire["desire"][3],6,  Lf.want["want"][3],8, str(instance.user.user_id), str(instance.approver.user_id)]
